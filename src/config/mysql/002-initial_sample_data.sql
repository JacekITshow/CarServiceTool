...
-- Create Sample RoleToUser
INSERT INTO RoleToUser (user_id, role_id)
VALUES
    (1, 1),
    (2, 2),
    (3, 2);
...
-- Create Sample PermissionToRole
INSERT INTO PermissionToRole (permission_id, role_id)
VALUES
    (1, 1),
    (2, 1),
    (3, 1),
...
-- Create Sample ChangePassword
INSERT INTO ChangePassword (user_id, hashcode, date)
VALUES
...
-- Create Sample ServiceToRepair
INSERT INTO ServiceToRepair (repair_id, service_id, cost)
VALUES
    (1, 1, 100),
    (2, 2, 200),
    (3, 3, 50),
...
-- Create Sample PartsToRepair
INSERT INTO PartsToRepair (repair_id, name, cost, description, part_code)
VALUES
