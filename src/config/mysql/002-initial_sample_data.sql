-- Create Sample user
INSERT INTO user (login, password, first_name, last_name, gender, email, phone_number, birthdate, description)
VALUES ('admin', '$2y$10$aZ9iT.v9m.eGd3b18u1bQ6eS4.2k3r.2zZ87868iZ27f14z65oH', 'John', 'Doe', 'Male',
        'john.doe@email.com', '+1234567890', '1980-01-01', 'Administrative user'),
       ('mechanic1', '$2y$10$8v8004hF81r72f/57gI00O.Y69Yj8v4.Y8a5k25.m3414722152', 'Jane', 'Smith', 'Female',
        'jane.smith@email.com', '+44123456789', '1990-02-02', 'Mechanic'),
       ('mechanic2', '$2y$10$fXs1h/g2xr838b3.2150g.a8093aP2Q2k08mY.054x0h6nXkG8e', 'Peter', 'Johnson', 'Male',
        'peter.johnson@email.com', '+33123456789', '1985-03-03', 'Mechanic');
...
VALUES (1, '$2y$10$3kI.k7.a02pO9j202x8s6u.b69432Yx6224891157.1114226171', '2023-10-04 12:34:56'),
...
VALUES (1, 'ABC123', 'PL', 'WXYZ456', 'Volkswagen', 'Golf', '2018', 'Gasoline', '2020-10-04', 'Regular maintenance'),
...
INSERT INTO repair (car_id, mileage, admission_date, estimated_date, description)
VALUES (1, 400000, '2023-10-04 12:00:00', '2023-10-06 14:00:00', 'Oil change and air filter replacement'),
       (2, 25000, '2023-01-05 09:00:00', '2023-01-07 11:00:00', 'Engine diagnostics and repair'),
       (3, 365232, '2023-03-12 15:00:00', '2023-03-13 17:00:00', 'Tire rotation and alignment');

-- Create Sample service
INSERT INTO service (name, recommended_cost, min_cost, max_cost, description)
VALUES ('Oil change and filter replacement', 100, 80, 120, 'Replace engine oil and filter'),
       ...
       ('Tire rotation and alignment', 50, 30, 70,
        'Rotate tires to ensure even wear and align wheels for optimal handling');
